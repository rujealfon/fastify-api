...
export const usersSchema = {
  list: { method: 'GET' as const, path: '/api/v1/users', tags: ['Users'], permission: 'user:read:any', query: paginationQuerySchema, responses: { 200: apiListSchema(userSchema), 401: apiErrorSchema, 403: apiErrorSchema } },
  ...
  create: { method: 'POST' as const, path: '/api/v1/users', tags: ['Users'], permission: 'user:create:any', body: createUserBodySchema, responses: { 201: apiSuccessSchema(userSchema), 401: apiErrorSchema, 403: apiErrorSchema, 409: apiErrorSchema } },
  ...
  delete: { method: 'DELETE' as const, path: '/api/v1/users/:id', tags: ['Users'], permission: 'user:delete:any', params: uuidParamSchema, responses: { 204: z.null(), 401: apiErrorSchema, 403: apiErrorSchema, 404: apiErrorSchema } },
  assignRole: { method: 'POST' as const, path: '/api/v1/users/:id/roles/:roleId', tags: ['Users'], permission: 'role:update:any', params: userRoleParamsSchema, responses: { 200: apiSuccessSchema(z.null()), 401: apiErrorSchema, 403: apiErrorSchema, 404: apiErrorSchema } },
  removeRole: { method: 'DELETE' as const, path: '/api/v1/users/:id/roles/:roleId', tags: ['Users'], permission: 'role:update:any', params: userRoleParamsSchema, responses: { 200: apiSuccessSchema(z.null()), 401: apiErrorSchema, 403: apiErrorSchema, 404: apiErrorSchema } },
} satisfies RouteMap
