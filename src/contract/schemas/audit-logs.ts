...
export const auditLogsSchema = {
  list: { method: 'GET' as const, path: '/api/v1/audit-logs', tags: ['Audit Logs'], permission: 'audit-log:read:any', query: paginationQuerySchema, responses: { 200: apiListSchema(auditLogSchema), 401: apiErrorSchema, 403: apiErrorSchema } },
