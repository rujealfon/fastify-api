...
export const permissionsSchema = {
  list: { method: 'GET' as const, path: '/api/v1/permissions', tags: ['Permissions'], permission: 'permission:read:any', responses: { 200: apiListSchema(permissionSchema), 401: apiErrorSchema, 403: apiErrorSchema } },
} satisfies RouteMap
